...
def octant_analysis(mod=5000):
    df1 = pandas.read_excel(r"input\1.0.xlsx")
    df2 = pandas.read_excel(r"input\2.0.xlsx")
    df3 = pandas.read_excel(r"input\2.5.xlsx")
    df4 = pandas.read_excel(r"input\3.0.xlsx")
    df5 = pandas.read_excel(r"input\3.4.xlsx")
    df6 = pandas.read_excel(r"input\3.7.xlsx")
    df7 = pandas.read_excel(r"input\4.0.xlsx")
    df8 = pandas.read_excel(r"input\4.2.xlsx")
    df9 = pandas.read_excel(r"input\4.4.xlsx")
    df10 = pandas.read_excel(r"input\4.6.xlsx")
    df11 = pandas.read_excel(r"input\4.7.xlsx")
    df12 = pandas.read_excel(r"input\4.8.xlsx")
    df13 = pandas.read_excel(r"input\4.9.xlsx")
    df14 = pandas.read_excel(r"input\5.0.xlsx")
    df15 = pandas.read_excel(r"input\5.1.xlsx")
    df16 = pandas.read_excel(r"input\5.2.xlsx")
    df17 = pandas.read_excel(r"input\5.3.xlsx")
    df18 = pandas.read_excel(r"input\surface.xlsx")


    
    inputfiles = [df1,df2,df3,df4,df5,df6,df7,df8,df9,df10,df11,df12,df13,df14,df15,df16,df17,df18]
    ...
    for df,out in zip(inputfiles,outputfiles):
