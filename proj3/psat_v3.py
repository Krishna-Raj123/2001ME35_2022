...
for file in files:
    ...
    out = st.button("Compute",key=str(random.randint(1,1000)))
    if out:
...
def fk():
    ...
    constant_fk2d=float(st.number_input("Enter onstant_fk2d value",key = "123"))
    multiplying_factor_3d=st.number_input("Enter multiplying_factor_3d",key ="ekdkjkj")
    Shear_velocity=st.number_input("Enter Shear_velocity",key='3') 
...
tch = (st.number_input('Chose Filtering Method From Above:',key='4'))
tch = int(tch)
if (tch == 1):
    corr = int(st.number_input('Enter thresold value C:',key='5'))
elif (tch == 2):
    SNR = int(st.number_input('Enter thresold value S:',key='6'))
elif (tch == 3):
    Lambda = st.number_input('Enter Lambda value for A:',key='7')
    k = st.number_input('Enter k value for A:',key='8')
    print(Lambda,k)
elif (tch == 4):
    corr = int(st.number_input('Enter thresold value C:',key='9'))
    SNR = int(st.number_input('Enter thresold value S:',key='a'))
elif (tch == 5):
    corr = int(st.number_input('Enter thresold value C:',key='b'))
    Lambda = st.number_input('Enter Lambda value for A:',key='c')
    k = st.number_input('Enter k value for A:',key='d')
elif (tch == 6):
    SNR = int(st.number_input('Enter thresold value S:',key='e'))
    Lambda = st.number_input('Enter Lambda value for A:',key='f')
    k = st.number_input('Enter k value for A:')
elif (tch == 7 or tch==8):
    corr = int(st.number_input('Enter thresold value C:',key='g'))
    SNR = int(st.number_input('Enter thresold value S:',key='h'))
    Lambda = st.number_input('Enter Lambda value for A:',key='i')
    k = st.number_input('Enter k value for A:',key='19')
else:
...
sch = int(st.number_input('Chose Replacement Method From Above:',key='j')) 
if sch> 7:
    st.write('Please enter correct choice...')
else:
    fileList = open('input_file_list.txt', 'r')
